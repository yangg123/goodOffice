...
//            NSString *icon=item[@"icon"];
            ...
            if(i!=0){
                ...
                separatorView.layer.zPosition = 1;
                NSLog(@"%f", separatorView.frame.origin.x);
...
- (void)initWithColors
{
    ...
    //选中的颜色
    self.selectedColor = [UIColor colorFromHexRGB:@"00d6be"];
    //边线的颜色
    self.borderColor = [UIColor colorFromHexRGB:@"00d6be"];
    
    //字体颜色
    self.textAttributes=@{NSFontAttributeName:[UIFont systemFontOfSize:15], NSForegroundColorAttributeName:[UIColor colorFromHexRGB:@"00d6be"]};
    
    //被选中的字体颜色
    self.selectedTextAttributes=@{NSFontAttributeName:[UIFont systemFontOfSize:15],
                                               NSForegroundColorAttributeName:[UIColor colorFromHexRGB:@"191d26"]};
}
...
{    //Setting border color
    ...
    for(UIView *separator in self.separators){
        ...
        NSLog(@"%f, %f", separator.frame.origin.x, self.borderWidth);
    }
